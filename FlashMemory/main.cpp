#include <cox.h>
#include <nrf5x/nRF5xFlashPage.hpp>
#include <BLEDevice.hpp>

nRF5xFlashPage ConfigMemory(0x7F000);

char keyBuf[256];

static void eventSW1Pressed() {
  reboot();
}
...
void setup() {
  ...
  System.onButtonPressed(0, eventSW1Pressed);
